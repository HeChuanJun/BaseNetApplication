...
import com.hcj.baseapplication.base.BaseConstant;
import com.hcj.baseapplication.base.GlobalApplication;
...
public class HttpMethods {
    ...
    public static String BASE_URL = BaseConstant.BASE_URL;
    ...
    private HttpMethods() {
         ...
         * 设置缓存
         */
        File cacheFile = new File(GlobalApplication.getInstance().getExternalCacheDir(), CACHE_NAME);
